...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Get all studio names that have published more than 2 movies: ");
        ...
        System.out.print("Get all studio names in which actor with name \"actor cu 2 oscaruri\" plays: ");
        for (Studio studio : studioDatabase) {
        ...
        System.out.print("Get all studio names in which at least one actor with age above 50 plays: ");
        for (Studio studio : studioDatabase) {
            Film[] filme = studio.getFilme();
            int nrActoriPeste50 = 0;
            for (Film film : filme) {
                Actor[] actori = film.getActori();
                for (Actor actor : actori) {
            ...
            if (nrActoriPeste50 >= 1) {
                System.out.print(studio.getNume() + " ");
            }
        }
        System.out.println("");

        // TODO: se poate face si cu lambda
    }
